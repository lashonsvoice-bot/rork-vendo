...
export default function RootLayout() {
  ...
  // Our ErrorBoundary component now handles web compatibility internally
  // It will automatically skip the error boundary on web if window.addEventListener is not available
  return (
    <ErrorBoundary>
