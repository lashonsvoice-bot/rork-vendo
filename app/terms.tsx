...
export default function TermsScreen() {
  const sections = useMemo(
    () => [
      ...
      {
        title: 'Penalties & Accountability Policy',
        content:
          'CONTRACTORS - Last-Minute Cancellation (within 48 hrs): Lose 50% of event fee (paid to host/business owner), strike recorded on profile (visible to owners). No-Show (no attendance, no notice): Lose 100% of event fee, automatic suspension + rating downgrade, must appeal with valid proof (doctor\'s note, jury duty, etc.). HOSTS - Last-Minute Cancellation (within 7 days): Lose supervisory/inventory management fee, must refund any prepaid host credits. Failure to Supervise/Check-In Contractors: Risk dispute + host rating downgrade, multiple disputes = suspension + loss of Verified Host badge. No-Show (host does not attend event): Lose 100% of host fee, immediate suspension until review. HOST REJECTION OF CONTRACTORS - Valid Rejection (venue rules, dress code, etiquette, professionalism): Contractor receives 30-50% of base fee + full travel/meal stipend, host keeps partial fee but must log rejection reason, Business Owner notified. Invalid or Excessive Rejections: Host flagged for review, repeated misuse = suspension + removal of Verified Host status, contractors are not penalized for being rejected. SHARED SAFEGUARDS - Escrow System: All payments held until event completion; funds redistributed if cancellation/no-show occurs. Appeals Process: Both hosts and contractors may appeal with supporting documents. Rating Impact: Repeated issues reduce visibility and priority in search results.'
      },
      {
