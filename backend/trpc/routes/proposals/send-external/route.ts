...
const sendExternalProposalProcedure = publicProcedure
  ...
  .mutation(async ({ input }) => {
    ...
    const contractorsLabel = contractorsNeeded === 1 ? 'contractor' : 'contractors';
