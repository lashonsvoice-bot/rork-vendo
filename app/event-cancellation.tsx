...
export default function EventCancellationScreen() {
  ...
  const cancelEventMutation = trpc.events.cancellation.cancel.useMutation();
  ...
  const handleCancel = async () => {
    ...
    Alert.alert(
      ...
      `Are you sure you want to cancel this event? ${isLessThan24Hours ? 'This will result in penalties due to less than 24 hours notice.' : ''}`,
      [
  ...
  const submitCancellation = async () => {
    ...
    try {
      ...
      if (result.penalties.automaticRating) {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.suspendedContainer}>
          ...
          <Text style={styles.suspendedMessage}>
            Your account has been suspended. Please check your email for appeal instructions.
          </Text>
          ...
          {suspensionQuery.data.suspensionDetails && (
            <View style={styles.suspensionDetails}>
              ...
              <Text style={styles.appealEmail}>
                Appeal Email: {suspensionQuery.data.suspensionDetails.appealEmail}
              </Text>
            </View>
          )}
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        {isLessThan24Hours && (
          <View style={styles.penaltiesCard}>
            <Text style={styles.penaltiesTitle}>Automatic Penalties</Text>
            
            <View style={styles.penaltyItem}>
              <Star size={20} color={theme.colors.error} />
              <Text style={styles.penaltyText}>
                Automatic 1-star rating (can be edited by business owner within 24 hours)
              </Text>
            </View>
            ...
            <View style={styles.penaltyItem}>
              ...
              <Text style={styles.penaltyText}>
                Business owners pay 10% compensation to hosts/contractors
              </Text>
            </View>
        ...
        <View style={styles.actionButtons}>
          ...
          <TouchableOpacity
            style={[styles.submitButton, (!reason.trim() || reason.length < 10) && styles.disabledButton]}
        ...
        <View style={styles.termsNotice}>
          <Text style={styles.termsText}>
            ...
            cancellation policies as outlined in our Terms and Conditions. RevoVend reserves 
            the right to suspend or remove accounts for any reason.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
